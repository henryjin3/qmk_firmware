...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_VOLD, KC_MUTE, KC_VOLU, KC_MPRV, KC_MNXT, KC_PSCR, KC_TRNS, KC_TRNS, LCTL(KC_HOME), KC_TRNS, KC_TRNS, LCTL(KC_END), KC_BSLS, KC_TRNS, 
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, KC_PENT, LT(2,KC_P0), KC_TRNS, KC_PDOT)
};
...
void encoder_update_user(uint8_t index, bool clockwise) {
    ...
    // move cursor horizontally by word
    // if (clockwise) {
